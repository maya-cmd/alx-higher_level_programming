...
class Base:
    ...
    def load_from_file(cls):
        """Method outputs  a list of classes instantiated
    ...
    def save_to_file_csv(cls, list_objs):
        """Method writes the CSV serialization of a list of objects to a file.
    ...
    def load_from_file_csv(cls):
        """Method returns a list of classes instantiated from a CSV file.
